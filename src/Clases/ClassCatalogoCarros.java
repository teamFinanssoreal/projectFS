 ...
 * @author svhju
 */
public class ClassCatalogoCarros {
    ...
    public ClassCatalogoCarros(int codigo, String descripcion, String numero_placa, String marca, String modelo, String color, String motor, String id_gps, String chip_gps, byte[] foto, String agencia_proveedora, int codigo_seleccion_agencia_para_vehiculo, int codigo_agencia_vehiculo) {
        this.codigo = codigo;
