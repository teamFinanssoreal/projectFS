 ...
 * @author svhju
 */
public class ClassFinanciamientoCarro_BuscarVehiculo {
    private int codigo;
    ...
    public ClassFinanciamientoCarro_BuscarVehiculo(int codigo, String descripcion, String marca, String modelo, String agencia_proveedora) {
        this.codigo = codigo;
