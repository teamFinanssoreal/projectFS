...
public class frmInAgenciasInfo extends javax.swing.JInternalFrame {
    ...
    public frmInAgenciasInfo() {
        ...
        //DESPLIEGA EL FRAME EN EL CENTRO DE LA PANTALLA
                ...
                ConexionBD.Iniciar();
                llenarCampos(ConexionBD.obtenerTodosLosDatosAgencias(codigo_agencia));
        ...
        if(txtNombre.getText().isEmpty()){
            ...
            if(!isNumeric(txtTelefono.getText())){
                ...
                if(contador.length()>2){
                    ...
                    ConexionBD.Iniciar();
                    resultadoInstruccion = ConexionBD.actualizarAgencias("VIGENTE", nombre, telefono, correo, calle, numcasa, zona, direccion, codigo_agencias);
                    ConexionBD.Finalizar();
...
private void llenarCampos(ResultSet estructuraTabla){
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
       frmInAgencias actualizarAgencia = new frmInAgencias();
       actualizarAgencia.actualizarDatosdesdeFuera();
