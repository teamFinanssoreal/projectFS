...
public class ClassFinanciamientoMoto_LlenarTabla {
    ...
    public ClassFinanciamientoMoto_LlenarTabla(int codigo, String condicion_credito,String numero_contrato, String capital, String dpi, String nombre, String descripcion) {
        this.codigo = codigo;
