 ...
 * @author svhju
 */
public class ClassFinanciamientoMoto_LlenarTabla {
    private int codigo;
    ...
    public ClassFinanciamientoMoto_LlenarTabla(int codigo, String numero_contrato, String condicion_credito, String capital, String dpi, String nombre, String descripcion) {
        this.codigo = codigo;
