 ...
 * @author svhju
 */
public class ClassCatalogoMotos_LlenarTabla {
    ...
    public ClassCatalogoMotos_LlenarTabla(int codigo, String descripcion, String marca, String modelo, String agencia_proveedora) {
        this.codigo = codigo;
