 ...
 */
public class ClassMostrarCatalogoMotosPapelera {
   private int codigo;
   ...
   private String agencia_proveedora;
    ...
    public ClassMostrarCatalogoMotosPapelera(int codigo, String descripcion, String marca, String modelo, String agencia_proveedora) {
        this.codigo = codigo;
